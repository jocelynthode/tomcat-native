...
final class OpenSslX509Certificate extends X509Certificate {
    ...
    private X509Certificate unwrap() {
        ...
        if (wrapped == null) {
            try {
                /* TODO OpenSSLContext.X509_CERT_FACTORY.generateCertificate changed to call directly instance */
                wrapped = this.wrapped = (X509Certificate) CertificateFactory.getInstance("X.509").generateCertificate(
